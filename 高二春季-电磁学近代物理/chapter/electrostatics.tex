...
I 	&=\frac{1}{2}\int\limits_{\rm I+II}\rho \varphi \ud V \\
	...
	&=\frac{1}{2}\intl_{\rm I}\rho_1 \varphi_1\ud V_1+\frac{1}{2}\intl_{\rm II}\rho_2 \varphi_2\ud V_2+\frac{1}{2}(\intl_{\rm I}\rho_1 \varphi_2\ud V_1+\intl_{\rm II}\rho_2 \varphi_1\ud V_2) \\
	&=I_1+I_2+I_{12}
\end{align*}
...
\[I_{12}=\int\limits_{\rm I}\int\limits_{\rm II}\ke\frac{\rho_1\rho_2}{r}\ud V_1\ud V_2=\intl_{\rm I}\rho_1 \varphi_2\ud V_1=\intl_{\rm II}\rho_2 \varphi_1\ud V_2\]
...
\[I=\frac{1}{2}\intl_V \rho\varphi\ud V\]

而又根据场与电荷之间的关系:
\[\nabla^2 \varphi=-\frac{\rho}{\varepsilon_0}\]

我们把以上积分写为:
\[I=-\frac{\varepsilon_0}{2}\intl_V \varphi\nabla^2\varphi\ud V\]
...
带入以上积分,\,我们得到:
\begin{align*}
I 	&=\frac{\varepsilon_0}{2}\intl_V (\nabla \varphi)^2\ud V-\frac{\varepsilon_0}{2}\ointl_{\partial V} \varphi\nabla\varphi\cdot\ud \bs{A}\\
	&=\intl_V \frac{\varepsilon_0}{2} \bs{E}^2 \ud V + \frac{\varepsilon_0}{2}\ointl_{\partial V} \varphi\bs{E}\cdot\ud \bs{A}
\end{align*}
...
\varphi 	&=\intl_{V'}\ke (\nabla'\cdot\frac{\bs{P}}{|\bs{R}|}-\frac{\nabla'\cdot \bs{P}}{|\bs{R}|})\ud V'\\
			&=\ointl_{\partial V'} \ke \frac{\bs{P}\cdot\ud \bs{A}'}{|\bs{R}|}+\intl_{V'}\ke\frac{-\nabla'\cdot \bs{P} \ud V'}{|\bs{R}|}\\
			&=\ointl_{\partial V'} \ke \frac{\sigma_P\ud A'}{|\bs{R}|}+\intl_{V'}\ke\frac{\rho_P \ud V'}{|\bs{R}|}
\end{align*}
...
\[\bs{E}=\ointl_{\partial V'} \ke \frac{\sigma_P\ud A'}{|\bs{R}|^2}\bs{e}_{\bs{R}}+\intl_{V'}\ke\frac{\rho_P \ud V'}{|\bs{R}|^2}\bs{e}_{\bs{R}}\]
