...
\ud \bs{F} 	&=\ud F_x \bs{e}_x+\ud F_y \bs{e}_y+\ud F_x \bs{e}_z \\
			&=\left(\frac{\partial F_x}{\partial x}\ud x+\frac{\partial F_x}{\partial y}\ud y+\frac{\partial F_x}{\partial z}\ud z\right)\bs{e}_x\\
			&\phantom{=}+\left(\frac{\partial F_y}{\partial x}\ud x+\frac{\partial F_y}{\partial y}\ud y+\frac{\partial F_y}{\partial z}\ud z\right)\bs{e}_y\\
			&\phantom{=}+\left(\frac{\partial F_z}{\partial x}\ud x+\frac{\partial F_z}{\partial y}\ud y+\frac{\partial F_z}{\partial z}\ud z\right)\bs{e}_z\\
			&=\left(\ud x\frac{\partial}{\partial x}+\ud y\frac{\partial}{\partial y}+\ud z\frac{\partial}{\partial z}\right)(F_x\bs{e}_x+F_y\bs{e}_y+F_z\bs{e}_z)\\
			&=\ud \bs{r}\cdot\nabla \bs{F}
\end{align*}
...
\frac{1}{|\bs{r}-\bs{r}_i|} 	&=[(\bs{r}-\bs{r}_i)^2]^{-\frac{1}{2}}=(\bs{r}^2-2\bs{r}_i\cdot\bs{r}+\bs{r}_i^2)^{-\frac{1}{2}} \\
								...
								&\approx \frac{1}{r}\left(1+\frac{\bs{r}_i\cdot\bs{r}}{r^2}\right)=\frac{1}{r}+\frac{\bs{r}}{r^3}\cdot \bs{r}_i \\
...
\begin{align*}
\varphi 	&=\int\limits_{V'}\ke \left(\nabla'\cdot\frac{\bs{P}}{|\bs{R}|}-\frac{\nabla'\cdot \bs{P}}{|\bs{R}|}\right)\ud V'\\
...
\[\bs{E}'=\begin{cases} \dfrac{\rho' r}{3\varepsilon_0}\bs{e}_r & (r<R)\\[6pt] \dfrac{\rho' R^3}{3\varepsilon_0 r^2}\bs{e}_r & (r>R) \end{cases}\]
...
\[\varphi=\begin{cases} \dfrac{1}{4\pi\varepsilon_0} \dfrac{Q}{R}& (r<R) \\[6pt] \dfrac{1}{4\pi\varepsilon_0} \dfrac{Q}{r} & (r>R) \end{cases} \quad,	\quad \bs{E}=\begin{cases}  \bs{0} & (r<R) \\[6pt] \dfrac{1}{4\pi\varepsilon_0} \dfrac{Q}{r^2}\bs{e}_r & (r>R) \end{cases}\]
...
\[\varphi=\begin{cases} -\dfrac{\rho }{6\varepsilon_0}r^2+C& (r<R) \\[6pt] \dfrac{1}{4\pi\varepsilon_0} \dfrac{Q}{r} & (r>R) \end{cases} \quad,	\quad \bs{E}=\begin{cases}  \dfrac{\rho }{3\varepsilon_0}r \bs{e}_r & (r<R) \\[6pt] \dfrac{1}{4\pi\varepsilon_0} \dfrac{Q}{r^2}\bs{e}_r & (r>R) \end{cases}\]
...
\[\bs{E}=\begin{cases}
-\dfrac{\bs{P}}{3\varepsilon_0}&(r<R)\\[6pt]
\dfrac{1}{4\pi\varepsilon_0} \frac{2p\cos\theta}{r^3}\bs{e}_r + \dfrac{1}{4\pi\varepsilon_0} \dfrac{p\sin\theta}{r^3}\bs{e}_\theta &(r>R)
\end{cases}\]

无奇异性,\,且也可以得到电势公式:
\[\varphi=\begin{cases}
\dfrac{P}{3\varepsilon_0}r\cos\theta &(r<R)\\[6pt]
\dfrac{1}{4\pi\varepsilon_0} \frac{p\cos\theta}{r^2}&(r>R)
\end{cases}\]
